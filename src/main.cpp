...
uint256 hashGenesisBlock("0x12b14cbb6d4c795e8b04f349385ff328f03643812776c53395c79222066aaeb7");
...
const string strMessageMagic = "SouthwestCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 500000); //SouthwestCoin cut subsidy every 500000 blocks
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60 * 5; // SouthwestCoin: 5 days
static const int64 nTargetSpacing = 300; // SouthwestCoin: 5 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal southwestcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SouthwestCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x73697e0a247ed3c94a0e720125642e522c1e3b821078c059cf87de6a0fbbe647");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Data tool helps Clark County schools boost graduation rates";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1513371603; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1556483;

        if (fTestNet)
        {
            block.nTime    = 1510088098;
            block.nNonce   = 324723;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb72ae3c630154c5c309b81901a10a5e851035083e569311e4c22cc19583e928f"));
